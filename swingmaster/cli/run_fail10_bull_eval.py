...
from swingmaster.research.fail10_bull_evaluation import evaluate_fail10_bull_models


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Evaluate existing FAIL10 BULL model artifacts (CatBoost vs HGB)."
    )
...
def main() -> None:
    ...
    try:
        ...
        summary = evaluate_fail10_bull_models(
            conn,
