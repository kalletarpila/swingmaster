...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Score selected FAIL10_BULL production candidate for BULL episodes."
    )
    ...
    parser.add_argument("--model-dir", required=True, help="Directory containing FAIL10_BULL artifacts")
    parser.add_argument(
        "--mode",
...
def main() -> None:
    ...
    try:
        ...
        result = compute_and_store_fail10_bull_scores(
            conn,
