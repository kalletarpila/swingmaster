...
MODEL_ID_CATBOOST = "FAIL10_SIDEWAYS_CATBOOST_V1"
MODEL_ID_HGB = "FAIL10_SIDEWAYS_HGB_V1"
COMPARISON_ID = "FAIL10_SIDEWAYS_MODEL_COMPARISON_V1"


@dataclass(frozen=True)
class Fail10SidewaysDataset:
    frame: pd.DataFrame
    feature_columns: tuple[str, ...]


@dataclass(frozen=True)
class Fail10SidewaysMetrics:
    n_train: int
    n_valid: int
    n_test: int
...
def load_fail10_sideways_dataset(conn: sqlite3.Connection, *, regime_version: str) -> Fail10SidewaysDataset:
    ...
    if frame.empty:
        return Fail10SidewaysDataset(frame=frame, feature_columns=tuple(FEATURE_COLUMNS))
...
def train_and_compare_fail10_sideways(
    conn: sqlite3.Connection,
    *,
    out_dir: Path,
    regime_version: str = DEFAULT_REGIME_VERSION,
    computed_at: str | None = None,
) -> Fail10SidewaysMetrics:
    ...
    features_path = out_dir / "FAIL10_SIDEWAYS_FEATURE_LIST_V1.json"
