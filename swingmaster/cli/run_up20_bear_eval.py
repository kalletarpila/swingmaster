...
from swingmaster.research.up20_bear_evaluation import evaluate_up20_bear_models


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Evaluate existing UP20 BEAR model artifacts (CatBoost vs HGB)."
    )
...
def main() -> None:
    ...
    try:
        ...
        summary = evaluate_up20_bear_models(
            conn,
