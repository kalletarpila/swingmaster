...
EVAL_ID = "FAIL10_BEAR_MODEL_EVAL_V1"
EVAL_FILE_NAME = f"{EVAL_ID}.json"
FEATURE_LIST_FILE_NAME = "FAIL10_BEAR_FEATURE_LIST_V1.json"
...
def evaluate_fail10_bear_models(
    ...
    *,
    ...
    if valid_df.empty or test_df.empty:
        raise RuntimeError("FAIL10_BEAR_SPLIT_EMPTY")
