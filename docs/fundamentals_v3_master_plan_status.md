...
Classification: `FUNDAMENTALS_V3_PHASE4C2D_SEC_COMPANY_FORMULA_DISCOVERY_COMPLETE_READY_FOR_PRODUCTION_APPLY`
...
AUTO_STRONG EBIT fills: `0`

AUTO_STRONG EBITDA fills: `444`
...
Current AUTO_STRONG EBIT fills: `0`

Current AUTO_STRONG EBITDA fills: `444`

Conclusion: `RESULT_B`

Next: `MASTER PLAN PHASE 4C-2F - FORMULA GATE REFINEMENT & RECOVERY REVALIDATION`
...
Final refined EBIT fills: `104`

Final refined EBITDA fills: `484`

Final refined core uplift: `484`

Next: `MASTER PLAN PHASE 4C-3 - EBIT & EBITDA PRODUCTION APPLY`

## Phase 4C-3

Classification: `FUNDAMENTALS_V3_PHASE4C3_EBIT_EBITDA_PRODUCTION_APPLY_COMPLETE_READY_FOR_REJECTED_CASE_REVIEW`
...
Score-ready dry observations: `29399`
...
Verified input file: `temp/phase8_period_end_R1_verified.csv`

Input reconciliation passed: rows `18`, unique quarters `18`, DIFFERENT `18`, HIGH confidence `18`, Candidate Value equals Verified Period End `18`, identity conflicts `0`.

Applied period_end repairs:
...
Retained R1 by guard: `COLLISION=10`, `SEQUENCE_CONFLICT=5`.

The retained rows were not written because applying the verified period_end while preserving the hard-locked FY/FQ identity would either duplicate another same-company period_end or break chronological FY/FQ ordering.

Production proof: quick_check `ok`, companies `2540 -> 2540`, canonical quarters `72765 -> 72765`, fundamentals rows `72765 -> 72765`, derived rows unchanged at `53815` for TTM, score, lifecycle, and valuation.

Same-company period_end duplicate groups stayed `3 -> 3`; A9 introduced no new period_end duplicate group.
