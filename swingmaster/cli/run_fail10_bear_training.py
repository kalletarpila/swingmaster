...
from swingmaster.research.fail10_bear_training import train_and_compare_fail10_bear


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train and compare FAIL10 BEAR candidates (CatBoost vs HGB)."
    )
