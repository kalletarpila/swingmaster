...
from swingmaster.research.fail10_sideways_training import train_and_compare_fail10_sideways


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train and compare FAIL10 SIDEWAYS candidates (CatBoost vs HGB)."
    )
