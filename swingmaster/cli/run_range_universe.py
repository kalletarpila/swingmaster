...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--policy-version", default="v3", help="Policy version")
    parser.add_argument("--signal-version", choices=["v2", "v3"], default="v3", help="Signal provider version")
