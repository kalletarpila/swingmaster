CREATE TABLE IF NOT EXISTS rc_fundamental_quarter_ingestion_status (
    ...
    source_confirmation_status TEXT NOT NULL DEFAULT 'SOURCE_CONFIRMATION_UNKNOWN',
    source_confirmation_source TEXT,
    last_sec_checked_at_utc TEXT,
    sec_confirmation_run_id TEXT,
