...
class IntegratedUpdateResult:
    ...
    def summary(self) -> dict[str, Any]:
        ...
        return {
            ...
            "source_overlap_count": self.preflight.get("source_overlap_count", 0),
            "duplicate_merge_count": self.preflight.get("duplicate_merge_count", 0),
            "floor_excluded_count": self.preflight.get("floor_excluded_count", 0),
