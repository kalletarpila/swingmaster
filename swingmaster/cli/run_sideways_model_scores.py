...
from swingmaster.research.fail10_sideways_scoring import compute_and_store_fail10_sideways_scores
from swingmaster.research.fail10_sideways_training import MODEL_ID_CATBOOST as FAIL10_MODEL_ID
from swingmaster.research.up20_bull_scoring import SCORE_TABLE
from swingmaster.research.up20_sideways_scoring import compute_and_store_up20_sideways_scores
from swingmaster.research.up20_sideways_training import MODEL_ID_HGB as UP20_MODEL_ID


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run SIDEWAYS model scoring flows (UP20 + FAIL10) and print combined coverage summary."
    )
    ...
    parser.add_argument("--model-dir", required=True, help="Directory containing SIDEWAYS model artifacts")
    parser.add_argument(
        "--mode",
...
def main() -> None:
    ...
    try:
        ...
        up20_result = compute_and_store_up20_sideways_scores(
            conn,
        ...
        fail10_result = compute_and_store_fail10_sideways_scores(
            conn,
            model_dir=Path(args.model_dir),
            regime_version=args.regime_version,
            mode=args.mode,
