...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Ingest raw macro source observations into RC SQLite")
    ...
    parser.add_argument("--fred-api-key", default=None, help="Optional FRED API key")
