...
MODEL_ID_CATBOOST = "UP20_BULL_CATBOOST_V1"
MODEL_ID_HGB = "UP20_BULL_HGB_V1"
COMPARISON_ID = "UP20_BULL_MODEL_COMPARISON_V1"


@dataclass(frozen=True)
class Up20BullDataset:
    frame: pd.DataFrame
    feature_columns: tuple[str, ...]


@dataclass(frozen=True)
class Up20BullMetrics:
    n_train: int
    n_valid: int
    n_test: int
...
def load_up20_bull_dataset(conn: sqlite3.Connection, *, regime_version: str) -> Up20BullDataset:
    ...
    if frame.empty:
        return Up20BullDataset(frame=frame, feature_columns=tuple(FEATURE_COLUMNS))
...
def train_and_compare_up20_bull(
    ...
    *,
    ...
    features_path = out_dir / "UP20_BULL_FEATURE_LIST_V1.json"
