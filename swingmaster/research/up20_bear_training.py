...
MODEL_ID_CATBOOST = "UP20_BEAR_CATBOOST_V1"
MODEL_ID_HGB = "UP20_BEAR_HGB_V1"
COMPARISON_ID = "UP20_BEAR_MODEL_COMPARISON_V1"


@dataclass(frozen=True)
class Up20BearDataset:
    frame: pd.DataFrame
    feature_columns: tuple[str, ...]


@dataclass(frozen=True)
class Up20BearMetrics:
    n_train: int
    n_valid: int
    n_test: int
...
def load_up20_bear_dataset(conn: sqlite3.Connection, *, regime_version: str) -> Up20BearDataset:
    ...
    if frame.empty:
        return Up20BearDataset(frame=frame, feature_columns=tuple(FEATURE_COLUMNS))
...
def train_and_compare_up20_bear(
    ...
    *,
    ...
    features_path = out_dir / "UP20_BEAR_FEATURE_LIST_V1.json"
