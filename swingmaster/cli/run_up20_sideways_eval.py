...
from swingmaster.research.up20_sideways_evaluation import evaluate_up20_sideways_models


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Evaluate existing UP20 SIDEWAYS model artifacts (CatBoost vs HGB)."
    )
...
def main() -> None:
    ...
    try:
        ...
        summary = evaluate_up20_sideways_models(
            conn,
    ...
    _summary(precision_at_0_60_valid_catboost=summary.precision_at_0_60_valid_catboost)
    ...
    _summary(top_10pct_up20_rate_test_catboost=summary.top_10pct_up20_rate_test_catboost)
    ...
    _summary(precision_at_0_60_valid_hgb=summary.precision_at_0_60_valid_hgb)
    ...
    _summary(top_10pct_up20_rate_test_hgb=summary.top_10pct_up20_rate_test_hgb)
