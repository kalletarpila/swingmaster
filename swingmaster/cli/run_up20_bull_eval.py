...
from swingmaster.research.up20_bull_evaluation import evaluate_up20_bull_models


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Evaluate existing UP20 BULL model artifacts (CatBoost vs HGB)."
    )
...
def main() -> None:
    ...
    try:
        ...
        summary = evaluate_up20_bull_models(
            conn,
