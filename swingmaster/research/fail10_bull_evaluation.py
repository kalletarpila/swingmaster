...
EVAL_ID = "FAIL10_BULL_MODEL_EVAL_V1"
EVAL_FILE_NAME = f"{EVAL_ID}.json"
FEATURE_LIST_FILE_NAME = "FAIL10_BULL_FEATURE_LIST_V1.json"
...
def evaluate_fail10_bull_models(
    conn: sqlite3.Connection,
    *,
    model_dir: Path,
