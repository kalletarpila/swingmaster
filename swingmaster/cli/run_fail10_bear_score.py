...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Score selected FAIL10_BEAR production candidate for BEAR episodes."
    )
    ...
    parser.add_argument("--model-dir", required=True, help="Directory containing FAIL10_BEAR artifacts")
    parser.add_argument(
        "--mode",
...
def main() -> None:
    ...
    try:
        ...
        result = compute_and_store_fail10_bear_scores(
            conn,
