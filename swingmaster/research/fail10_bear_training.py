...
MODEL_ID_CATBOOST = "FAIL10_BEAR_CATBOOST_V1"
MODEL_ID_HGB = "FAIL10_BEAR_HGB_V1"
COMPARISON_ID = "FAIL10_BEAR_MODEL_COMPARISON_V1"


@dataclass(frozen=True)
class Fail10BearDataset:
    frame: pd.DataFrame
    feature_columns: tuple[str, ...]


@dataclass(frozen=True)
class Fail10BearMetrics:
    n_train: int
    n_valid: int
    n_test: int
...
def load_fail10_bear_dataset(conn: sqlite3.Connection, *, regime_version: str) -> Fail10BearDataset:
    ...
    if frame.empty:
        return Fail10BearDataset(frame=frame, feature_columns=tuple(FEATURE_COLUMNS))
...
def train_and_compare_fail10_bear(
    ...
    *,
    ...
    features_path = out_dir / "FAIL10_BEAR_FEATURE_LIST_V1.json"
