...
from swingmaster.research.fail10_bull_training import train_and_compare_fail10_bull


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train and compare FAIL10 BULL candidates (CatBoost vs HGB)."
    )
