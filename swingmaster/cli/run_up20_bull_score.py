...
from swingmaster.research.up20_bull_scoring import compute_and_store_up20_bull_hgb_scores


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Score UP20_BULL_HGB_V1 probabilities for BULL episodes."
    )
    ...
    parser.add_argument("--model-dir", required=True, help="Directory containing UP20_BULL_HGB_V1 artifact")
    parser.add_argument(
        "--mode",
...
def main() -> None:
    ...
    try:
        ...
        result = compute_and_store_up20_bull_hgb_scores(
            conn,
