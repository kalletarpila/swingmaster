...
Output directory: `analysis_output/seed_ecosystem_graph_datacenter_2024_2026_wide`
...
- Seed raw min correlation: `0.3`
- Seed residual min correlation: `0.15`
- General raw min correlation: `0.35`
- General residual min correlation: `0.2`
- Second-hop min combined score: `0.35`
- Overall min combined score: `0.25`
- Max first-hop nodes: `500`
- Max second-hop nodes: `1000`
...
first-hop nodes by best seed edge score. Retain at most 500 first-hop nodes.
...
second-hop min combined score. Retain at most 1000 second-hop nodes.
...
- Retained first-hop nodes: `500`
- Retained second-hop nodes: `1000`
- Graph nodes: `1530`
- Graph edges: `208361`
- Components (total): `1`
- First-hop candidates: `1435`
- Second-hop candidates: `65`
- Cross-sector edges: `149364`
- Cliques found: `20000`
