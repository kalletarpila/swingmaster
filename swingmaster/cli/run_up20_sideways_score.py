...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Score selected UP20_SIDEWAYS production candidate for SIDEWAYS episodes."
    )
    ...
    parser.add_argument("--model-dir", required=True, help="Directory containing UP20_SIDEWAYS artifacts")
    parser.add_argument(
        "--mode",
...
def main() -> None:
    ...
    try:
        ...
        result = compute_and_store_up20_sideways_scores(
            conn,
