...
from swingmaster.research.fail10_sideways_evaluation import evaluate_fail10_sideways_models


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Evaluate existing FAIL10 SIDEWAYS model artifacts (CatBoost vs HGB)."
    )
...
def main() -> None:
    ...
    try:
        ...
        summary = evaluate_fail10_sideways_models(
            conn,
